...
impl TryFrom<&Expr> for protobuf::LogicalExprNode {
    ...
    fn try_from(expr: &Expr) -> Result<Self, Self::Error> {
        ...
        let expr_node = match expr {
            ...
            Expr::ScalarSubquery(_) | Expr::InSubquery { .. } | Expr::Exists { .. } | Expr::OuterColumn { .. } => {
                ...
                return Err(Error::General("Proto serialization error: Expr::ScalarSubquery(_) | Expr::InSubquery { .. } | Expr::Exists { .. } | Expr::OuterColumn { .. } not supported".to_string()));
            }
